                            ...
                            <form style="align-content: center;">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="visi" id="compose-textarea" class="form-control"></textarea>
                                        @error('visi')
                                        <small>{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="misi" id="misi-textarea" class="form-control"></textarea>
                                        @error('misi')
                                        <small>{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <!-- <textarea name="content" id="compose-textarea" class="form-control"></textarea> -->
                                        <textarea name="ourbout" id="ourbout-textarea" class="form-control"></textarea>
                                        @error('ourbout')
                                        <small>{{ $message }}</small>
                                        @enderror
                                    </div>
