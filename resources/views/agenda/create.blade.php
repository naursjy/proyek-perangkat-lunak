...
<!-- <link rel="stylesheet" href="{{ asset('path/to/boot strap-datetimepicker.css') }}"> -->
<style>
    .custom-option {
                            ...
                            <form style="align-content: center;">
                                <div class="card-body">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="time" name="time" class="form-control" id="exampleInputEmail1" placeholder="date">
                                        @error('time')
                                        <small>{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lokasi" class="form-control" id="exampleInputEmail1" placeholder="title">
                                        @error('lokasi')
                                        <small>{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan" id="keterangan-textarea" class="form-control"></textarea>
                                        @error('misi')
                                        <small>{{ $message }}</small>
                                        @enderror
                                    </div>
