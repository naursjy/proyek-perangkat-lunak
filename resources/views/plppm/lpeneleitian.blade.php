             ...
             <div class="row mb-2">
                 ...
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item"><a href="{{ route('plppm.lpeneleitian') }}">Home</a></li>
                     ...
                     <div class="card">
                         <div class="card-header">
                             ...
                             <div class="card-tools">
                                 <form action="{{ route('plppm.lpeneleitian') }}" method="GET">
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="btn-group" role="group">
                                                 <a href="{{ route('detail.detail', ['tipe' => 'ajupenel', 'id' => $d->id]) }}" class="btn btn-info text-white"><i class="fas fa-eye white"></i></a>
                                                 <!-- <a href="{{ route('dosen.edit_ajuanpenelitian',['id' => $d->id]) }}" class="btn btn-primary"><i class="fas fa-pen"></i></a> -->
                                             ...
                                             <div class="btn-group">
                                                 ...
                                                 <div class="dropdown-menu">
                                                     <!-- Approve -->
                                                     <form action="{{ route('plppm.ppenelitian.status', $d->id) }}" method="POST" class="px-3 py-1">
                                                         @csrf
                                                         @method('patch')
