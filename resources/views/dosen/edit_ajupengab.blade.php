...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('dosen.updatep3m' , ['id' => $penelitian->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="custom-select form-control-border" id="exampleSelectBorder" name="prodi">
                                                            ...
                                                            <option value="AP" {{ (isset($penelitian) && $penelitian->prodi == 'AP') ? 'selected' : '' }}>Agre Bisnis Perternakan</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group ">
                                                    ...
                                                    <div class="anggota-row border p-2 mb-2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="custom-select form-control-border" id="exampleSelectBorder" name="anggota[{{ $i }}][prodi]">
                                                                ...
                                                                <option value="AP" {{ (isset($anggota) && $anggota->prodi == 'AP') ? 'selected' : '' }}>Agre Bisnis Perternakan</option>
                                                            </select>
                                                            @error('prodi')
                                                            <small>{{ $message }}</small>
                                                            @enderror
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="anggota[{{ $i }}][nim]" placeholder="Prodi" value="{{ $anggota->nim }}">
                                                            @error('prodi')
                                                            <small>{{ $message }}</small>
                                                            @enderror
                                                        </div>
