                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <a href="{{ route('dosen.edit_kpenliti',['id' => $d->id]) }}" class="btn btn-primary"><i class="fas fa-pen"></i></a>
                                                <a href="{{ route ('dosen.delete', ['id' => $d->id]) }}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                            </div>
                                        </td>
