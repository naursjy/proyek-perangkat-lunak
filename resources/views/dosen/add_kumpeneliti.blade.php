...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('dosen.storekumpulanpenelitian') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="Laporan Penelitian Masyarakat" name="jeniskategori" readonly>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="custom-select form-control-border" id="exampleSelectBorder" name="prodi">
                                                            ...
                                                            <option value="AP" {{ old('prodi') == 'AP' ? 'selected' : '' }}>Agribisnis Pertanian</option>
